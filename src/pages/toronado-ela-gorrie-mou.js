...
export default ({ data }) => {
    ...
    <Row className="heroimage">
        <Col lg={12} className="heroimage">
            ...
            <Img fluid={data.image11.childImageSharp.fluid} className="mx-auto d-block img-fluid" />
            </div>
        </Col>
    </Row>
        <Container>  
            <div className="text-center">
                <h1 className="index-heading pt-3">Makarios</h1>
            </div>
            <Row>
                <Col lg={6}>
                  <div className="text-center pt-2 syndicate-padding">
                    ...
                    <Table bordered className="">
                        ...
                        <tr>
                          <td><strong>AGE:</strong> 4</td>
                        </tr>
                        <tr>
                          <td><strong>DESCRIPTION:</strong> BAY GELDING</td>
                        </tr>
                        <tr>
                          <td><strong><a href="https://www.racingpost.com/profile/horse/715700/ela-gorrie-mou" target="_blank" rel="noreferrer">VIEW DAM PROFILE</a></strong></td>
                        </tr>
                        <tr>
                ...
                <Col lg={6} className="text-center">
                    ...
                    <p className="">This late developing big, strong 4 year old gelding is showing promise on the Newmarket gallops. Expect to see him racing in the middle of the flat grass season in 2022.</p>
                </Col>
